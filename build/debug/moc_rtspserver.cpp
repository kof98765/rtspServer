...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RtspServer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RtspServer_t qt_meta_stringdata_RtspServer = {
    {
...
QT_MOC_LITERAL(9, 78, 28),
QT_MOC_LITERAL(10, 107, 11)
    },
    "RtspServer\0closeSocket\0\0newConnect\0"
    "tcpDate\0initSocked\0ip\0tcpport\0"
    "displayError\0QAbstractSocket::SocketError\0"
    "socketError"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_RtspServer[] = {
...
void RtspServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RtspServer *_t = static_cast<RtspServer *>(_o);
        switch (_id) {
        case 0: _t->closeSocket(); break;
        case 1: _t->newConnect(); break;
        case 2: _t->tcpDate(); break;
        case 3: _t->initSocked((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
...
const QMetaObject RtspServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_RtspServer.data,
      qt_meta_data_RtspServer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RtspServer.stringdata))
        return static_cast<void*>(const_cast< RtspServer*>(this));
